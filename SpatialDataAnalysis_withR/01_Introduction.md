...
[<i class="fa fa-file-code-o fa-3x" aria-hidden="true"></i> The R Script associated with this page is available here](01_Introduction.R).  Download this file and open it (or copy-paste into a new script) with RStudio so you can follow along.  
...
![](01_Introduction_files/figure-html/unnamed-chunk-29-1.png)<!-- -->
...
```
##           [,1]       [,2]        [,3]
## [1,]  1.970410  0.3805717  0.01080093
## [2,] -1.313228 -2.4760330 -1.21478185
## [3,]  1.029883 -0.7515918  1.25088190
```
</div>
</div>
